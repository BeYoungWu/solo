...
<%-- 관리자페이지 인터셉터 --%>
<%
String unauthorizedMessage = (String) request.getSession().getAttribute("unauthorizedMessage");
if (unauthorizedMessage != null && !unauthorizedMessage.isEmpty()) {
%>
<div class="alert alert-danger">${unauthorizedMessage}</div>
<%
    // 경고 메시지를 표시한 후 세션에서 제거
    request.getSession().removeAttribute("unauthorizedMessage");
}
%>
<%-- END --%>
