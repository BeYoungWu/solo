...
<jsp:include page="/WEB-INF/views/include/admin-header.jsp" />
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body" style="text-align:center">
					<form id="registerSong" action="registerSong" method="post" enctype="multipart/form-data">
						<div class="filebox">
	...
	<div class="modal fade" id="modify-file" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form id="modifySong" action="modifySong" method="post" enctype="multipart/form-data">
				<div>
	...
	$(function() {
		$('.modify-btn').on('click', function(event) { // 클릭한 교사의 데이터 비동기 방식으로 가져오기
			...
			$.ajax({
				"method":"GET",
				"url":"/admin/getSongData",
				"data": {},
				"success":function(data, xhr, status){
					$('#modifySong input[name=prevUserFileName]').val(data.userFileName);
					$('#modifySong input[name=prevFileNo]').val(data.fileNo);
				},
	...
	<div class="modal" id="delete-file" tabindex="-1">
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <form id="delete-form" action="deleteSong" method="get">
	...
	<div class="contatiner">
		<div class="row">
			<div class="col-lg-12">
				<div class="img">
					<img src="/resources/img/song/${ file.savedFileName }" alt="">
				</div>
			</div>
		</div>
	</div>
