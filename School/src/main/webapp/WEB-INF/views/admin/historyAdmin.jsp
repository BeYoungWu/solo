...
<jsp:include page="/WEB-INF/views/include/admin-header.jsp" />
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body" style="text-align:center">
					<form id="registerHistory" action="registerHistory" method="post" enctype="multipart/form-data">
						<div class="filebox">
	...
	<div class="modal fade" id="modify-file" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form id="modifyHistory" action="modifyHistory" method="post" enctype="multipart/form-data">
	...
	$(function() {
		$('.modify-btn').on('click', function(event) { // 클릭한 교사의 데이터 비동기 방식으로 가져오기
			...
			$.ajax({
				"method":"GET",
				"url":"/admin/getHistoryData",
				"data": {},
				"success":function(data, xhr, status){
					$('#modifyHistory input[name=prevUserFileName]').val(data.userFileName);
					$('#modifyHistory input[name=prevFileNo]').val(data.fileNo);
				},
	...
	<div class="modal" id="delete-file" tabindex="-1">
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <form id="delete-form" action="deleteHistory" method="get">
