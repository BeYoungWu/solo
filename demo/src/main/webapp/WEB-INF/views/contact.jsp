				...
				<div class="row">
					<div class="col-lg-3">
						<div class="widget">
							...
							<address>
								<strong>Abovecompany Inc</strong><br> JC Main Road, Near
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-6">
							<div class="copyright">
								<p>
									<span>&copy; Above Site All right reserved. Template By
									</span><a href="http://webthemez.com" target="_blank">WebThemez</a>
								</p>
							</div>
						</div>
						<div class="col-lg-6">
